        ...
        <div>
            ...
            <main className="container">
                <form className="registration-form" onSubmit={handleSubmit}>
                    ...
                    <label htmlFor="project-name">Project Name <span>* (Required)</span></label>
                    ...
                    <label htmlFor="project-image">Project Image <span>* (Required)</span></label>
                    ...
                    <label htmlFor="link">Live Link <span>(Optional)</span></label>
                    <input type="text" id="link" name="liveLink" value={formData.liveLink} onChange={handleChange} placeholder='Enter Live Link'/>

                    <label htmlFor="github-link">Github Link <span>(Optional)</span></label>

                ...
                <div className="information-container">
                    {selectedCandidate ? (
                        <div className="info">
                            ...
                            <h3>Project Image:</h3>
                            <img src={`${IMG_URL}/admin/image/${selectedCandidate.pImage}`} alt={selectedCandidate.pName} />
                            <h3><a style={{cursor:'pointer'}} href={selectedCandidate.liveLink} target="_blank" rel="noopener noreferrer">Live Project Link</a></h3>
                        </div>
                    ) : (
                        <div className="info">
                            <h2>Select a Candidate to See Details</h2>
                            {/* Default "Welcome" Image */}
                            <img src="https://aliruddro.site/wp-content/uploads/2025/04/New-Banner-Update-Final.jpg" alt="Welcome" className="default-image" />
                        </div>
                    )}
                    {selectedCandidate && (

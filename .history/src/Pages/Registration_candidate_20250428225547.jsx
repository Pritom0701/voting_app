        ...
        <div>
            ...
            <main className="container">
                <form className="registration-form" onSubmit={handleSubmit}>
                    ...
                    <textarea name="pDetails" value={formData.pDetails} onChange={handleChange} id="project-details"></textarea>
                    <input type="text" id="project-details" name="pDetails" value={formData.pDetails} onChange={handleChange} placeholder='Enter Your Name'/>

...
const Home = () => {
    ...
    const [hasVoted, setHasVoted] = useState(false);  // ✅ New state to track voting
    ...
    const handleVote = async (candidateId) => {
        try {
            ...
            setHasVoted(true); // ✅ After voting, set hasVoted to true
        } catch (error) {
                ...
                <div className="information-container">
                    ...
                    {selectedCandidate && (
                        <button 
                            ...
                            disabled={hasVoted}   // ✅ Disable button if already voted
                        >
                            {hasVoted ? 'Already Voted' : `Vote for ${selectedCandidate.name}`}
                        </button>
                    )}
                </div>

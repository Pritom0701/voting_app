        ...
        <div>
            ...
            <main className="container">
                <form className="registration-form" onSubmit={handleSubmit}>
                    ...
                    <input type="text" id="fullname" required name="name" value={formData.name} onChange={handleChange} />

                    <label htmlFor="phone">Phone Number <span>*</span></label>
                    <input type="tel" id="phone" required name="phone" value={formData.phone} onChange={handleChange} />

                    <label htmlFor="project-name">Project Name <span>*</span></label>
                    <input type="text" id="project-name" required name="pName" value={formData.pName} onChange={handleChange} />
                    ...
                    <input type="text" id="project-details" name="pDetails" value={formData.pDetails} onChange={handleChange} />

                    <label htmlFor="link">Live Link</label>
                    <input type="text" id="link" name="liveLink" value={formData.liveLink} onChange={handleChange} />

                    <label htmlFor="github-link">Github Link </label>
                    <input type="text" id="github-link" name="githubLink" value={formData.githubLink} onChange={handleChange} />
